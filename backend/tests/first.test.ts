...
test("should create tierarztpraxis", async () => {
  ...
  await expect(
    prismaMock.veterinarypractices.create({
      data: {
        name: "Tierarztpraxis Mitte",
        phone: "030123456",
        infoemail: "info@praxis.de",
