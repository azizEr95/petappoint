        ...
        <VStack className='gap-4 pt-2'>
          ...
          <Box className='flex-row gap-3'>
            <VStack className='flex-1 gap-1'>
              <Text size='lg' className='font-medium text-gray-600'>Vorname</Text>
            ...
            <VStack className='flex-1 gap-1'>
              <Text size='lg' className='font-medium text-gray-600'>Nachname</Text>
              <Input className='bg-white rounded-xl border-0 shadow-sm h-12'>
          ...
          <VStack className='gap-1'>
            <Text size='lg' className='font-medium text-gray-600'>Geschlecht</Text>
            <Box className='flex-row flex-wrap gap-2'>
              {SEX_OPTIONS.map((opt) => (
                <Pressable
                  key={opt.value}
                  onPress={() => setSex(opt.value)}
                  className={`px-4 py-2 rounded-xl border ${sex === opt.value ? 'bg-primary-500 border-primary-500' : 'bg-white border-gray-200'}`}
                >
                  <Text
                    size='sm'
                    className={sex === opt.value ? 'text-white font-semibold' : 'text-gray-600'}
                  >
                    {opt.label}
                  </Text>
                </Pressable>
          ...
          {/* Phone */}
          <VStack className='gap-1'>
            <Text size='lg' className='font-medium text-gray-600'>Telefon</Text>
            <Input className='bg-white rounded-xl border-0 shadow-sm h-12'>
              <InputField
          ...
          {/* Email */}
          <VStack className='gap-1'>
            <Text size='lg' className='font-medium text-gray-600'>E-Mail</Text>
            <Input className='bg-white rounded-xl border-0 shadow-sm h-12'>
              <InputField
          ...
          {/* Address */}
          <VStack className='gap-1'>
            <Text size='lg' className='font-medium text-gray-600'>Straße & Hausnummer</Text>
            <Input className='bg-white rounded-xl border-0 shadow-sm h-12'>
          ...
          <Box className='flex-row gap-3'>
            <VStack className='gap-1' style={{ width: 100 }}>
              <Text size='lg' className='font-medium text-gray-600'>PLZ</Text>
              <Input className='bg-white rounded-xl border-0 shadow-sm h-12'>
                <InputField
                  placeholder='12345'
                  value={cityCode}
            ...
            <VStack className='flex-1 gap-1'>
              <Text size='lg' className='font-medium text-gray-600'>Stadt</Text>
              <Input className='bg-white rounded-xl border-0 shadow-sm h-12'>
          ...
          {/* Password */}
          <VStack className='gap-1'>
            <Text size='lg' className='font-medium text-gray-600'>Passwort</Text>
            <Input className='bg-white rounded-xl border-0 shadow-sm h-12'>
              <InputField
                placeholder='••••••••'
                value={password}
          ...
          <VStack className='gap-1'>
            <Text size='lg' className='font-medium text-gray-600'>Passwort bestätigen</Text>
            <Input className='bg-white rounded-xl border-0 shadow-sm h-12'>
              <InputField
                placeholder='••••••••'
