...
function Grid({ ref, className, _extra, children, ...props }: IGridProps & { ref?: React.RefObject<React.ComponentRef<typeof View> | null> }) {
...
function GridItem({ ref, className, _extra, ...props }: IGridItemProps & { ref?: React.RefObject<React.ComponentRef<typeof View> | null> }) {
  const {
    calculatedWidth,
    numColumns,
    itemsPerRow,
