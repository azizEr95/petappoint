...
function Link({ ref, className, ...props }: ILinkProps & { ref?: React.RefObject<React.ComponentRef<typeof UILink> | null> }) {
  return (
    <UILink
      ref={ref}
      {...props}
...
function LinkText({ ref, className, size = 'md', ...props }: ILinkTextProps & { ref?: React.RefObject<React.ComponentRef<typeof UILink.Text> | null> }) {
  return (
    <UILink.Text
      ref={ref}
      {...props}
