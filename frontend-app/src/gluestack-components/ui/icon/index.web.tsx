...
export function Icon({ ref, size = 'md', className, ...props }: React.ComponentPropsWithoutRef<typeof UIIcon>
  & VariantProps<typeof iconStyle> & {
    height?: number | string
    width?: number | string
  } & { ref?: React.RefObject<React.ComponentRef<typeof UIIcon> | null> }) {
...
function accessClassName(style: any) {
...
function createIconUI({ ...props }: ParameterTypes) {
  ...
  return function UIIcon({ ref, className, ...inComingprops }: React.ComponentPropsWithoutRef<typeof UIIcon>
    & VariantProps<typeof iconStyle> & {
      height?: number | string
      width?: number | string
    } & { ref?: React.RefObject<React.ComponentRef<typeof UIIcon> | null> }) {
