...
function Input({ ref, className, variant = 'outline', size = 'md', ...props }: IInputProps & { ref?: React.RefObject<React.ComponentRef<typeof UIInput> | null> }) {
  return (
    <UIInput
      ref={ref}
      {...props}
...
function InputIcon({ ref, className, size, ...props }: IInputIconProps & { ref?: React.RefObject<React.ComponentRef<typeof UIInput.Icon> | null> }) {
...
function InputSlot({ ref, className, ...props }: IInputSlotProps & { ref?: React.RefObject<React.ComponentRef<typeof UIInput.Slot> | null> }) {
  return (
    <UIInput.Slot
      ref={ref}
      {...props}
...
function InputField({ ref, className, ...props }: IInputFieldProps & { ref?: React.RefObject<React.ComponentRef<typeof UIInput.Input> | null> }) {
