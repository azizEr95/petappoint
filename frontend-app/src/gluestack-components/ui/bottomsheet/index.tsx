...
export function BottomSheetPortal({
  ...
  const { bottomSheetRef, handleClose } = use(BottomSheetContext)
...
export function BottomSheetTrigger({
  ...
  const { handleOpen } = use(BottomSheetContext)
  return (
    <Pressable
      onPress={(e) => {
...
export function BottomSheetContent({ ...props }: IBottomSheetContent) {
  const { handleClose, visible } = use(BottomSheetContext)
...
export function BottomSheetItem({
  ...
  const { handleClose } = use(BottomSheetContext)
  return (
    <Pressable
      {...props}
...
export function BottomSheetItemText({ ...props }: TextProps) {
  return <Text {...props} />
}
