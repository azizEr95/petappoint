...
function ActionsheetContent({ ref, className, ...props }: IActionsheetContentProps & { className?: string } & { ref?: React.RefObject<React.ComponentRef<typeof UIActionsheet.Content> | null> }) {
  return (
...
function ActionsheetItemText({ ref, className, isTruncated, bold, underline, strikeThrough, size, ...props }: IActionsheetItemTextProps & { ref?: React.RefObject<React.ComponentRef<typeof UIActionsheet.ItemText> | null> }) {
  return (
...
function ActionsheetIcon({ ref, className, as: AsComp, size = 'sm', ...props }: IActionsheetIconProps & { ref?: React.RefObject<React.ComponentRef<typeof UIActionsheet.Icon> | null> }) {
  if (AsComp) {
    return (
      <AsComp
