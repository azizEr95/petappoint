import { AppointmentsSchema, type AppointmentsType } from "../../../shared/schemas/ZodSchemas";

export const getAppointmentsById = async (id: string): Promise<AppointmentsType> => {
...
export const getAvailableAppointmentsByPracticeId = async (practiceId: string): Promise<AppointmentsType[]> => {
