...
VALUES
  ...
  ('2025-11-13 22:00', '2025-11-13 22:45', NULL, 1, 1),
  ('2025-11-15 11:00', '2025-11-15 11:45', 8, 4, 1),
  ('2025-11-16 13:00', '2025-11-16 13:45', 2, 4, 1),
  ('2025-11-18 13:00', '2025-11-18 13:45', 1, 4, 1),
  ('2025-11-19 09:30', '2025-11-19 10:15', NULL, 2, 1),
  ('2025-11-19 14:00', '2025-11-19 14:45', NULL, 1, 1),
  ('2025-11-19 15:00', '2025-11-19 16:00', 2, 4, 1),
  ('2025-11-20 16:30', '2025-11-20 17:00', NULL, 2, 1),
  ('2025-11-22 08:00', '2025-11-22 08:45', NULL, 4, 1),
  ('2025-11-22 09:00', '2025-11-22 09:45', NULL, 1, 1),
  ('2025-11-25 18:00', '2025-11-25 18:30', 1, 2, 1),
  ('2025-11-28 10:00', '2025-11-28 10:45', 8, 4, 1),
  ('2025-11-30 16:30', '2025-11-30 17:00', NULL, 2, 1),
  ('2025-11-26 08:00', '2025-11-26 08:45', NULL, 4, 1),
  ('2025-11-24 09:00', '2025-11-24 09:45', NULL, 1, 1),
  ('2025-12-02 12:00', '2025-12-02 12:45', 2, 1, 1),
  ('2025-12-02 13:00', '2025-12-02 13:30', NULL, 1, 1),
  ('2025-12-04 11:30', '2025-12-04 12:15', NULL, 1, 1),
  ('2025-12-07 20:00', '2025-12-07 21:00', NULL, 2, 1),
  ('2025-12-07 14:30', '2025-12-07 15:15', NULL, 1, 1),
  ('2025-12-10 10:00', '2025-12-10 10:30', 8, 4, 1),
  ('2025-12-10 14:00', '2025-12-10 15:00', 2, 2, 1),
  ('2025-12-14 11:30', '2025-12-14 12:15', NULL, 1, 1),
  ('2025-12-16 20:00', '2025-12-16 21:00', NULL, 2, 1),
  ('2025-12-18 14:30', '2025-12-18 15:15', NULL, 1, 1),
  ('2025-12-22 11:30', '2025-12-22 12:15', NULL, 1, 1),
  ('2025-12-24 20:00', '2025-12-24 21:00', NULL, 2, 1),
  ('2025-12-28 14:30', '2025-12-28 15:15', NULL, 1, 1);
-- Praxis 2
INSERT INTO appointments (startTime, endTime, fk_animalId, fk_veterinaryId, fk_veterinaryPracticeId)
VALUES
  ('2025-11-17 09:00', '2025-11-17 09:30', 2, 2, 2),
  ('2025-11-17 14:00', '2025-11-17 14:45', NULL, 4, 2),
  ('2025-11-19 11:30', '2025-11-19 12:00', NULL, 2, 2),
  ('2025-11-19 14:30', '2025-11-19 15:30', 1, 1, 2),
  ('2025-11-21 16:00', '2025-11-21 16:45', 2, 4, 2),
  ('2025-11-20 15:00', '2025-11-20 15:45', NULL, 2, 2),
  ('2025-11-20 17:00', '2025-11-20 17:30', NULL, 4, 2),
  ('2025-11-22 09:45', '2025-11-22 10:15', NULL, 4, 2),
  ('2025-11-24 15:00', '2025-11-24 15:45', NULL, 2, 2),
  ('2025-11-25 17:00', '2025-11-25 17:30', NULL, 4, 2),
  ('2025-11-25 09:45', '2025-11-25 10:15', NULL, 4, 2),
  ('2025-11-30 10:30', '2025-11-30 11:15', 2, 1, 2),
  ('2025-11-25 19:00', '2025-11-25 19:45', NULL, 2, 2),
  ('2025-11-28 08:30', '2025-11-28 09:15', 8, 4, 2),
  ('2025-12-02 11:00', '2025-12-02 11:45', NULL, 1, 2),
  ('2025-12-02 15:00', '2025-12-02 15:45', NULL, 1, 2),
  ('2025-12-02 16:00', '2025-12-02 16:30', 2, 2, 2),
  ('2025-12-10 12:00', '2025-12-10 12:45', 1, 4, 2),
  ('2025-12-10 15:30', '2025-12-10 16:15', NULL, 2, 2),
  ('2025-12-14 12:10', '2025-12-14 12:45', 1, 4, 2),
  ('2025-12-15 15:45', '2025-12-15 16:15', NULL, 2, 2),
  ('2025-12-20 10:30', '2025-12-20 11:00', NULL, 1, 2);
-- Praxen 3-5
INSERT INTO appointments (startTime, endTime, fk_animalId, fk_veterinaryId, fk_veterinaryPracticeId)
VALUES
